...
/// inconsistencies between and amongst the letter abbreviations for dynamics (what is _sf_ vs. _sfz_,
...
/// a single element, such as _sfmp_. These letter dynamic symbols are separated from crescendo,
